...
var swagger_config_1 = require("./config/swagger/swagger.config");
var http_exception_filter_1 = require("./common/filters/http-exception.filter");
var transform_response_interceptor_1 = require("./common/interceptors/transform-response.interceptor");
function bootstrap() {
